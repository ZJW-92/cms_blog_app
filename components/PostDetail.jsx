...
const PostDetail = ({ post }) => {
  ...
  return (
    <>
      <div className="bg-white rounded-lg lg:p-6 pb-10 mb-10">
        <div className="mb-8">
          <img src={post.featuredImage.url} alt="" className="object-top h-auto w-full rounded-t-lg lg:rounded-lg" />
        </div>
        ...
        <div className="px-4 lg:px-0">
          <div className="flex items-center mb-8 w-full">
            <div className=" md:flex lg:mb-0 lg:w-auto mr-8 items-center">
              <img
                alt={post.author.name}  height="32px" width="32px" className="rounded-full"
                src={post.author.photo.url}/>
              <p className=" text-gray-600 ml-3 font-medium text-lg">{post.author.name}</p>
            </div>
